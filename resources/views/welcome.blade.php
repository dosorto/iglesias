...
<head>
    ...
    <title>Sistema de Iglesias UNAH</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* NAV */
        .lp-nav { display: flex; align-items: center; justify-content: space-between; padding: 1.25rem 2.5rem; border-bottom: 1px solid rgba(255,255,255,0.08); }
        .nav-logo { display: flex; align-items: center; gap: 10px; text-decoration: none; }
        .nav-logo-icon { width: 38px; height: 38px; background: #534AB7; border-radius: 9px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        ...
        .lp-hero h1 span { color: #7F77DD; }
        .lp-hero p { font-size: 1.05rem; color: rgba(255,255,255,0.58); line-height: 1.75; margin-bottom: 2.5rem; }
        .hero-btns { display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; }
        .btn-primary { background: #534AB7; color: #fff; border: none; border-radius: 10px; padding: 13px 30px; font-size: 14px; font-weight: 600; text-decoration: none; display: inline-block; transition: background .2s; }
        .btn-primary:hover { background: #6B61D4; color: #fff; }
        ...
        .section-eyebrow { font-size: 12px; color: #7F77DD; text-transform: uppercase; letter-spacing: .1em; margin-bottom: .6rem; }
        ...
        .feat-card:hover { border-color: rgba(83,74,183,0.5); }
        ...
        .step-num { width: 42px; height: 42px; background: #534AB7; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 15px; font-weight: 600; color: #fff; margin: 0 auto 1rem; }
        ...
        /* CTA */
        .lp-cta { background: rgba(83,74,183,0.14); border: 1px solid rgba(83,74,183,0.28); border-radius: 18px; padding: 4.5rem 2rem; text-align: center; max-width: 680px; margin: 0 auto 5rem; }
        ...
        /* FOOTER */
        .lp-footer { padding: 2.5rem; text-align: center; border-top: 1px solid rgba(255,255,255,0.07); }
...
<body>
    ...
    <nav class="lp-nav">
        <a href="/" class="nav-logo">
            <div class="nav-logo-icon">
                <svg width="20" height="20" fill="none" stroke="#AFA9EC" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/>
                    <polyline points="9 22 9 12 15 12 15 22"/>
                </svg>
            </div>
            <span class="nav-logo-text">Sistema Iglesias UNAH</span>
        </a>
        <div class="nav-links">
    ...
    <section class="lp-hero">
        ...
        <p>Administra feligreses, sacramentos, matrimonios y certificados desde un solo lugar. Diseñado para iglesias que quieren custodiar su historia con reverencia y tecnología.</p>
        <div class="hero-btns">
            <a href="{{ route('register.organization') }}" class="btn-primary">Registrar mi iglesia</a>
    ...
    <section class="lp-section" id="caracteristicas">
        ...
        <p class="section-sub">Desde el censo de feligreses hasta la emisión de certificados digitales, cubrimos cada proceso administrativo de tu iglesia.</p>
        <div class="feat-grid">
            <div class="feat-card">
                <div class="feat-icon" style="background:rgba(83,74,183,0.2)">
                    <svg width="20" height="20" fill="none" stroke="#AFA9EC" stroke-width="2" viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon" style="background:rgba(29,158,117,0.15)">
                    <svg width="20" height="20" fill="none" stroke="#5DCAA5" stroke-width="2" viewBox="0 0 24 24"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon" style="background:rgba(212,83,126,0.15)">
                    <svg width="20" height="20" fill="none" stroke="#ED93B1" stroke-width="2" viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon" style="background:rgba(55,138,221,0.15)">
                    <svg width="20" height="20" fill="none" stroke="#85B7EB" stroke-width="2" viewBox="0 0 24 24"><path d="M12 6.253v11.494m-5.747-8.12l11.494 4.373M6.253 14.373l11.494-4.373"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon" style="background:rgba(186,117,23,0.15)">
                    <svg width="20" height="20" fill="none" stroke="#EF9F27" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                </div>
            ...
            <div class="feat-card">
                <div class="feat-icon" style="background:rgba(83,74,183,0.15)">
                    <svg width="20" height="20" fill="none" stroke="#AFA9EC" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg>
                </div>
                <h3>Multi-iglesia</h3>
                <p>Cada iglesia tiene su propia base de datos aislada. Seguridad y privacidad garantizadas.</p>
            </div>
        </div>
    </section>
    ...
    <section class="lp-section" id="sacramentos" style="padding-top: 0;">
        ...
        <div class="sacr-grid">
            <div class="sacr-card">
                <div class="sacr-dot" style="background:rgba(83,74,183,0.45)"></div>
                <h4>Bautismo</h4>
                <p>Registro y certificado</p>
            </div>
            <div class="sacr-card">
                <div class="sacr-dot" style="background:rgba(212,83,126,0.45)"></div>
                <h4>Matrimonio</h4>
                <p>Acta y testigos</p>
            </div>
            <div class="sacr-card">
                <div class="sacr-dot" style="background:rgba(29,158,117,0.45)"></div>
                <h4>Confirmación</h4>
                <p>Padrinos y padrinas</p>
            </div>
            <div class="sacr-card">
                <div class="sacr-dot" style="background:rgba(186,117,23,0.45)"></div>
                <h4>Comunión</h4>
                <p>Historial sacramental</p>
            </div>
            <div class="sacr-card">
                <div class="sacr-dot" style="background:rgba(55,138,221,0.45)"></div>
                <h4>Cursos</h4>
    ...
    <section class="lp-section" id="como-funciona" style="padding-top: 0;">
        ...
        <div class="steps">
            <div class="step">
                ...
                <p>Crea tu cuenta con los datos básicos de tu parroquia y elige la religión correspondiente.</p>
            </div>
            <div class="step">
    ...
    <div style="padding: 0 2rem;">
        <div class="lp-cta">
            ...
            <p>Crea tu cuenta en minutos. Solo necesitas el nombre de tu iglesia y los datos del administrador para comenzar de forma gratuita.</p>
    ...
    <footer class="lp-footer">
        <p>Sistema de Iglesias UNAH · "Custodiando la fe y la historia de nuestra comunidad parroquial con reverencia y orden."</p>
    </footer>
