                    ...
                    <main class="mt-6">
                        @guest
                            <div class="mb-6 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <h1 class="text-2xl font-semibold text-black dark:text-white">Comienza creando tu Iglesia</h1>
                                <p class="mt-2 text-sm text-black/70 dark:text-white/70">
                                    Registra tu Iglesia en 2 pasos, crea tu usuario administrador y accede al sistema inmediatamente.
                                </p>
