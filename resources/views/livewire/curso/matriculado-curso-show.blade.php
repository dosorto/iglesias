<div class="space-y-4">
    @if (session()->has('error'))
        <div class="bg-red-100 dark:bg-red-900/30 border border-red-300 dark:border-red-700 text-red-800 dark:text-red-200 px-3 py-2 rounded-lg text-xs">
            {{ session('error') }}
        </div>
    @endif

    @if (session()->has('success_estado'))
        <div class="bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700 text-green-800 dark:text-green-200 px-3 py-2 rounded-lg text-xs">
    ...
    <div class="flex justify-between items-center mb-4">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Viendo la información detallada del matriculado.
            </p>
        </div>
