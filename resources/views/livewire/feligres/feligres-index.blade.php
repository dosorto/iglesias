                            ...
                            >
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">{{ $item->persona->nombre_completo }}</div>
                                ...
                                <td class="px-6 py-4" onclick="event.stopPropagation()">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @can('feligres.delete')
                                            <button
                                                wire:click="confirmFeligresDeletion('{{ $item->id }}', '{{ $item->persona->nombre_completo }}')"
