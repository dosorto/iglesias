                    ...
                    <div class="flex items-center justify-between px-5 py-3
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            @if ($advertenciaDuplicado)
                                <div class="mb-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 p-3">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-semibold text-amber-800 dark:text-amber-300">Posible persona duplicada</p>
                                            <p class="text-xs text-amber-700 dark:text-amber-400 mt-0.5">
                                                Ya existe <strong>{{ $advertenciaDuplicado }}</strong> sin número de identidad.
                                                ¿Deseas registrar otra persona con el mismo nombre?
                                            </p>
                                            <div class="flex items-center gap-3 mt-2">
                                                <button type="button" wire:click="confirmarYCrearPersona"
