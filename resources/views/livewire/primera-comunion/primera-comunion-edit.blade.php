    ...
    <div class="bg-white dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700/60 ring-1 ring-black/5 dark:ring-white/5">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                {{-- Libro --}}
                <div>
                    <label class="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wide">Libro de Comunión <span class="text-red-500">*</span></label>
           ...
           {{-- ══ SECCIÓN 2: Catequista y Ministro — sin Párroco manual (se toma del encargado) ══ --}}
<div x-data="{ open: {{ ($catequista_estado === 'found' || $ministro_estado === 'found') ? 'true' : 'false' }} }"
    ...
    <button type="button" @click="open = !open"
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="text-left">
                <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Catequista y Ministro</p>
