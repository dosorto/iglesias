    ...
    <div class="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600
        ...
        <div class="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-white leading-tight">Registrar Nuevo Tipo de Curso</h1>
                    <p class="text-blue-100 text-sm mt-0.5">
                        Completa los datos para agregar un nuevo tipo de curso al sistema.
                    </p>
                </div>
            </div>
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mt-8 pt-5 border-t border-gray-100 dark:border-gray-700/50">
                ...
                <button type="button"
                    ...
                    <span wire:loading.remove wire:target="guardar">Guardar Tipo de Curso</span>
