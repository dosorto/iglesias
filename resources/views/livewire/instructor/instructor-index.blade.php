<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Gestión de Instructores</h1>
            <p class="text-gray-600 dark:text-gray-300 mt-1">Administra los instructores registrados y su firma principal</p>
        </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                    <div class="flex items-center gap-4">
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Lista de Instructores</h2>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                            {{ $instructores->total() }} {{ $instructores->total() === 1 ? 'registro' : 'registros' }}
                        </span>
                    </div>
                                ...
                                <td class="px-6 py-4" onclick="event.stopPropagation()">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @can('instructor.delete')
                                            <button
                                                wire:click="confirmInstructorDeletion('{{ $item->id }}', '{{ $item->feligres->persona->nombre_completo }}')"
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        @if(!$search && auth()->user()->can('instructor.create'))
                                            <a href="{{ route('instructor.create') }}"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full overflow-hidden border border-gray-200 dark:border-gray-700 anim-scale-in">
                <div class="p-6">
                    ...
                    <div class="text-center">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">¿Eliminar Instructor?</h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            Estás a punto de eliminar a <span class="font-semibold text-gray-900 dark:text-white">{{ $instructorNameBeingDeleted }}</span>.
