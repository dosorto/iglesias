<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Formato de Certificado de Bautismo</h1>
            <p class="text-gray-600 dark:text-gray-300 mt-1">Sube la imagen que se usará como fondo del certificado</p>
        </div>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg px-4 py-3 text-sm text-blue-700 dark:text-blue-300">
        <strong>Nota:</strong> La imagen subida se mostrará como fondo del certificado de bautismo en la vista de detalle y al generar el PDF.
        Se recomienda usar una imagen de tamaño carta (2550 × 3300 px) en formato PNG con fondo transparente.
    </div>
