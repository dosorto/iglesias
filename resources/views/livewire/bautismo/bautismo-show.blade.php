        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 space-y-3">
            ...
            <div>
                ...
                <textarea wire:model="nota_marginal" rows="2"
                 ...
                 <div>
                  <label class="block text-xs text-gray-400 dark:text-gray-500 mb-1">Sacerdote que bautizó (texto libre / registro histórico)</label>
                 ...
                 <div>
                  <label class="block text-xs text-gray-400 dark:text-gray-500 mb-1">Párroco del momento</label>
                 ...
                 <div>
                  <label class="block text-xs text-gray-400 dark:text-gray-500 mb-1">Lugar de Celebración <span class="text-red-500">*</span></label>
                  <input wire:model="lugar_celebracion" type="text"
                      class="w-full px-2 py-1.5 text-xs rounded-md border border-gray-300 dark:border-gray-600
                          bg-white dark:bg-gray-700 text-gray-900 dark:text-white
                          focus:ring-1 focus:ring-blue-500 focus:border-transparent">
                 </div>
            ...
            <div class="rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden bg-gray-50 dark:bg-gray-900">
                @if ($datosCriticosFaltantes)
                    <div class="p-6 text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/20">
                        <p>Vista previa no disponible. Complete los datos requeridos del bautismo.</p>
                    </div>
                @else
                    <iframe
                        src="{{ $pdfPreviewUrl }}"
