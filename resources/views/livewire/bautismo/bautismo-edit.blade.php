<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Bautismo</h1>
            <p class="text-gray-600 dark:text-gray-300 mt-1">Modifica los datos del registro bautismal</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input wire:model="fecha_bautismo" type="date"
                           class="block w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md
                                  focus:ring-2 focus:ring-blue-500 focus:border-transparent
                                  dark:bg-gray-700 dark:text-white">
                    @error('fecha_bautismo') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                </div>
                ...
                <div>
                    ...
                    @error('encargado_id') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                </div>

                {{-- Libro --}}
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Libro de Bautismo</label>
                    <input wire:model="libro_bautismo" type="text"
                           class="block w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md
                                  focus:ring-2 focus:ring-blue-500 focus:border-transparent
                                  dark:bg-gray-700 dark:text-white"
                           placeholder="Ej: Libro III">
                    @error('libro_bautismo') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                </div>
