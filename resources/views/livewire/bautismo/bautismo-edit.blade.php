                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text"
                           ...
                           class="w-full px-3 py-2.5 text-sm rounded-lg transition-colors
                                  ...
                                  bg-white dark:bg-gray-700/60 text-gray-900 dark:text-white placeholder-gray-400
                                  focus:ring-2 focus:ring-indigo-500 focus:border-transparent
                                  @error('ministro_celebrante') border-red-400 bg-red-50 dark:bg-red-900/10 @enderror" />
                    @error('ministro_celebrante')
                        <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           class="w-full px-3 py-2.5 text-sm rounded-lg transition-colors
                                  ...
                                  bg-white dark:bg-gray-700/60 text-gray-900 dark:text-white placeholder-gray-400
                                  focus:ring-2 focus:ring-indigo-500 focus:border-transparent
                                  @error('lugar_celebracion') border-red-400 bg-red-50 dark:bg-red-900/10 @enderror" />
                    @error('lugar_celebracion')
                        <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
