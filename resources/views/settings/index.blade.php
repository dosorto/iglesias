...
@endcan
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Certificado de Bautismo</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300">Formato o fondo del certificado</p>
                </div>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-sm text-gray-500 dark:text-gray-400">
                    @if (\App\Models\Iglesias::first()?->path_certificado_bautismo)
                        Formato configurado
                    @else
                        Sin formato personalizado
                    @endif
                </span>
