...
<div class="container-fluid max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white uppercase tracking-wider">Detalle de Instructor</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Información completa del instructor e historial de cambios.</p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('instructor.index') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200 text-sm font-medium">
                Volver
            </a>
            @can('instructor.edit')
                <a href="{{ route('instructor.edit', $instructor) }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm font-medium">
                    Editar
                </a>
            @endcan
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $instructor->feligres->persona->nombre_completo }}</p>
                    ...
                    <div>
                        ...
                        <p class="text-md font-medium text-gray-900 dark:text-white">{{ $instructor->feligres->iglesia->nombre }}</p>
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Estado Feligrés</label>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $instructor->feligres->estado === 'Activo' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300' }}">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-indigo-200 dark:border-indigo-700 overflow-hidden">
                ...
                <div class="px-6 py-4">
                    <a href="{{ route('feligres.show', $instructor->feligres) }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:underline">
                            ...
                            <li>
                                <div class="relative pb-8">
                                    ...
                                    <div class="relative flex space-x-3">
                                        <div>
                                            @php
                                                $colors = ['created' => 'bg-green-500', 'updated' => 'bg-blue-500', 'deleted' => 'bg-red-500'];
                                            @endphp
