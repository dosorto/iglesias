...
<div class="container-fluid max-w-4xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Registrarr Nuevo Encargado</h1>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <select name="id_feligres" id="id_feligres" required
                        ...
                        @foreach($feligres as $item)
                            <option value="{{ $item->id }}" {{ old('id_feligres') == $item->id ? 'selected' : '' }}>
                    ...
                    @enderror
                    @if($feligres->isEmpty())
                        <p class="mt-1 text-sm text-yellow-600 dark:text-yellow-400">No hay feligreses disponibles sin encargado asignado.</p>
                    @endif
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="path_firma_principal" id="path_firma_principal"
                           value="{{ old('path_firma_principal') }}"
