...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-wrapper { padding: 30px 46px; border: 4px double #7D5A1E; margin: 10px; }
        ...
        .sig-img {
            ...
            object-fit: contain;
            display: block;
            margin: 0 auto;       /* imagen centrada, pegada a la línea */
        }
        .sig-line {
            display: inline-block;
            width: 260px;
            border-top: 2px solid #7D5A1E;
            margin-top: 0;        /* línea inmediatamente bajo la imagen */
            padding-top: 4px;
        }
...
@php
    ...
    if ($confirmacion->encargado?->path_firma_principal) {
        $abs = public_path('storage/' . $confirmacion->encargado->path_firma_principal);
