...
<head>
    ...
    <title>Certificados de Cursos Aprobados</title>
    <style>
...
<body>
    @foreach ($inscripciones as $inscripcion)
        @php
            ...
            $diaCert = $fechaCertificado?->day ?? now()->day;
            $mesCert = $fechaCertificado ? $mesesEs[$fechaCertificado->month] : $mesesEs[now()->month];
            $anoCert = $fechaCertificado?->year ?? now()->year;
        ...
        <div class="page-wrapper {{ ! $loop->last ? 'page-break' : '' }}">
            ...
            <div class="issuance">
                <p>
                    Emitido el
                    <span class="line-field line-field-sm">{{ $diaCert }}</span>
                    de
                    <span class="line-field">{{ $mesCert }}</span>
                    de
                    <span class="line-field line-field-sm">{{ $anoCert }}</span>
                </p>
