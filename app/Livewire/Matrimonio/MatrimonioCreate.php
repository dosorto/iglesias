...
class MatrimonioCreate extends Component
{
    ...
    public function guardar(): void
    {
        ...
        $this->validate([
            ...
            'libro_matrimonio' => ['required', 'string', 'max:100'],
            ...
            'libro_matrimonio.required' => 'El libro de matrimonio es obligatorio.',
            'libro_matrimonio.max'      => 'El libro de matrimonio no puede superar los 100 caracteres.',
            'folio.required'            => 'El folio es obligatorio.',
            'folio.max'                 => 'El folio no puede superar los 50 caracteres.',
            'partida_numero.required'   => 'El n̼mero de partida es obligatorio.',
            'partida_numero.max'        => 'El n̼mero de partida no puede superar los 50 caracteres.',
        ...
        Matrimonio::create([
            ...
            'libro_matrimonio' => trim($this->libro_matrimonio),
